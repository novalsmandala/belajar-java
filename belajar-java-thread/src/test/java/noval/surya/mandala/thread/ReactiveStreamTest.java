...
public class ReactiveStreamTest {
    ...
    void publish() throws InterruptedException {
        ...
        var subscriber1 = new PrintSubscriber("Agus", 1000L);
        var subscriber2 = new PrintSubscriber("Budi", 500L);
    ...
    void buffer() throws InterruptedException {
        ...
        var publisher = new SubmissionPublisher<String>(Executors.newWorkStealingPool(), 32);
        var subscriber1 = new PrintSubscriber("Agus", 1000L);
        var subscriber2 = new PrintSubscriber("Budi", 500L);
        publisher.subscribe(subscriber1);
        publisher.subscribe(subscriber2);
